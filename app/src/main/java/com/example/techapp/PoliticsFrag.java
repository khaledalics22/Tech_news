 ...
 */
public class PoliticsFrag extends Fragment implements LoaderManager.LoaderCallbacks<List<TechReportClass>> {
    ...
    private final int POLITICS_LOADER = 5;
    ...
    private void loadMore() {
        pageNum++;
        buildUrl(cul_url);
        getActivity().getSupportLoaderManager().restartLoader(POLITICS_LOADER, null, this);
    }
    ...
    private void loadReports() {
        try {
            if (isInternetConnected()) {
                showResponseStatus(LOAD_PROGRESS);
                getActivity().getSupportLoaderManager().initLoader(POLITICS_LOADER, null, this);
            } else {
    ...
    private String buildUrl(String url) {
        ...
        builder.appendQueryParameter("section", "politics")
